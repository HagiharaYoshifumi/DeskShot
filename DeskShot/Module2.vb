...
Module Module2
    ...
    Public Function CaptureScreen(Optional i As Integer = 0) As Bitmap
        ...
        Dim bmp As New Bitmap(Screen.AllScreens(i).WorkingArea.Width, Screen.AllScreens(i).WorkingArea.Height)
        'Graphicsの作成
        Using g As Graphics = Graphics.FromImage(bmp)
            g.CopyFromScreen(New Point(Screen.AllScreens(i).WorkingArea.X, Screen.AllScreens(i).WorkingArea.Y), New Point(0, 0), bmp.Size)
        End Using
        Return bmp
    End Function
    ...
    Public Function CaptureActiveWindow(Value As PosiShift_Collection) As Bitmap
        ...
        Dim _ShiftX As Integer = Value.X, _ShiftY As Integer = Value.Y
        Dim _ShiftHeight As Integer = Value.Height, _SiiftWidth As Integer = Value.Width
